...
#define LED_R BIT2 // P1.2
#define LED_G BIT1 // P1.1
#define LED_B BIT0 // P1.0
...
int main(void) {
    ...
    BCSCTL1 = CALBC1_16MHZ;          // 8 Mhzde dahili osilatörmüzün çalisacagini belirttim
    DCOCTL = CALDCO_16MHZ;           // SMCLK = DCO = 8MHz
   ...
   // Port çikislarini sifirlama (ledler kapali)
